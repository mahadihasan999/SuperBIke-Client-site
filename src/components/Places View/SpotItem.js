...
const SpotItem = ({ img, star, country, cost, name }) => {
    ...
    return (
        <div className="bg-white border border-gray-200 transition transform duration-700 hover:shadow-xl hover:scale-105 p-4 rounded-lg relative">
            ...
            <div className="flex flex-col items-center my-3 space-y-2">
                <h1 className="text-gray-900 poppins text-lg">{star}</h1>
                <p className="text-gray-500 poppins text-sm text-center">{country}</p>
