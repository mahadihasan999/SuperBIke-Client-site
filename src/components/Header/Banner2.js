    ...
    return (
        <div className="overflow-y-hidden">
            <div className="relative flex justify-center items-center md:justify-start ">
                <img className="hidden lg:block  w-full" src="https://www.teahub.io/photos/full/289-2890298_suzuki-moto-gsxr-suzuki-gsxr1000-motorbikes-wallpaper-moto.jpg" alt="randeer" />
