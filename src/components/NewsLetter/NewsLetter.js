    ...
    return (
        <div className="2xl:mx-auto 2xl:container mx-4 py-16">
            <div className=" w-full  relative flex items-center justify-center">
                <img src="https://pbs.twimg.com/profile_banners/1273613672/1401216126/1500x500" alt="dining" className="w-full h-full absolute z-0 hidden xl:block" />
                <img src="https://pbs.twimg.com/profile_banners/1273613672/1401216126/1500x500" alt="dining" className="w-full h-full absolute z-0 hidden sm:block xl:hidden" />
                <img src="https://pbs.twimg.com/profile_banners/1273613672/1401216126/1500x500" alt="dining" className="w-full h-full absolute z-0  sm:hidden " />
