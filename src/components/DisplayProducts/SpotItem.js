...
const SpotItem = ({ image, price, name }) => {
        ...
        <div className="mx-auto container px-6 xl:px-0 py-12">
            <div className="flex flex-col">
                ...
                <div className="group group-hover:bg-opacity-60 transition duration-500 relative bg-gray-50 sm:p-28 py-36 px-10 flex justify-center items-center">
                    <img onClick={handleRoute} style={{ cursor: 'pointer' }} className="group-hover:opacity-60 transition duration-500 pointer" src={`data:image/*;base64,${image}`} alt="sofa-7" />
                    <div className="absolute sm:top-8 top-4 left-4 sm:left-8 flex justify-start items-start flex-col space-y-2">
                        <div>
                            <p className="group-hover:opacity-60 transition duration-500 text-xl leading-5 text-gray-600">{name}</p>
                        </div>
                        <div>
