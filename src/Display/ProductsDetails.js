...
const ProductsDetails = () => {
    ...
    const onSubmit = data => {
        ...
        history.push('/');
        swal("success!", "Pending Admin Approval!", "success");
    };
    ...
    return (
        <main className="max-w-screen-xl mx-auto px-6 my-5">
            {
                loading ? <Spinner /> :
                                ...
                                <div className="flex flex-col justify-start items-start w-full space-y-9">
                                    <div className="flex justify-start flex-col items-start space-y-2">
                                        <button className="flex flex-row items-center text-gray-600 hover:text-gray-500 space-x-1">
                                            ...
                                            <Link to='/'><button className="text-sm leading-none">Back</button></Link>
                                        </button>
